...
function ScrollCourseCard() {
    return (
        <div className='courseCardBox'>
            <p style={{ color: '#674818', marginLeft: '0px', marginTop: '4rem', marginBottom: '0px', fontSize: 'xx-large', padding: '0px' }}>All that you need in one place </p>
